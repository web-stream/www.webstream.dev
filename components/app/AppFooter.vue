<template>
  <footer
    ...
    bg-webstream
  "
    :class="{ 'mt-28 sm:mt-36 md:mt-48 lg:mt-64': !isHome }" aria-label="footerHeading">
    ...
    <div :class="!isHome ? 'bg-bg-webstream dark:bg-secondary-black' : 'bg-secondary-darker'">
      <div
        ...
        <div>
          <section id="subscribe-to-newsletter">
            ...
            <form class="mt-4 sm:flex sm:justify-start" @submit.prevent="subscribe">
              <AppInput v-model="email" placeholder="footer.newsletter.form.email" />
              <AppButton
                type="sumbit"
...
export default defineComponent({
  ...
  setup() {
    ...
    const socials = [
      {
        href: 'https://twitter.com/webstream_dev',
        icon: 'IconTwitter',
